...
public class ExperimentationMain {
	...
	public static void main(String[] args) throws CloneNotSupportedException {
		...
		ec.addStrategy(new StrategiesTimeCollection<Integer>(new CocktailSortSorter<Integer>("Cocktail Sorter")));
		ec.addStrategy(new StrategiesTimeCollection<Integer>(new CombSortSorter<Integer>("Comb Sorter")));
