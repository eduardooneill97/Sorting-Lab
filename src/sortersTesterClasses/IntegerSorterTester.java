...
public class IntegerSorterTester {
	...
	public static void main(String[] args) { 
		...
		testEntero("Sorting Entero using DefaultComparator", null);
	}
	...
	private static void testEntero(String msg, Comparator<Entero> cmp) { 
		...
		showArrayEntero("Original Entero array: ", arr);
		
		Sorter<Entero> x = new BubbleSortSorter<Entero>();
		x.sort(arr, cmp);
		
		showArrayEntero("Entero array after sort:", arr);
		
	}
	
	private static void showArrayEntero(String msg, Entero[] a) {
		System.out.print(msg); 
		for (int i=0; i<a.length; i++) 
			System.out.print("\t" + a[i]); 
		System.out.println();
